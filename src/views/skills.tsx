				...
				<Grid container direction="column" alignItems="left">
					...
					<Grid container p={3} mt={2} css={skillItem} direction="row">
						<Grid item container xs={4} direction="column">
							...
							<img alt="backend" src="images/backend.png" css={css`width:240px;`} loading="lazy" />
						</Grid>
						<Grid item container xs={5} direction="column">
							...
							<img alt="deploy" src="images/deploy.png" css={css`width:420px;`} loading="lazy" />
						</Grid>
					...
					<Grid container p={3} mt={2} css={skillItem} direction="column">
						...
						<img alt="etc" src="images/etc.png" css={css`width:800px;`} loading="lazy" />
					</Grid>
				</Grid>
			</Grid>
		</Grid>
